...
do
   ffmpeg -i "$f" -i logo/lower.avi -i logo/logo.png -filter_complex \
      ...
      [bg1][2:v]overlay=10:10,drawtext=fontfile=/home/mirko/PycharmProjects/videoPlayer_old/logo/BebasNeue-Bold.otf:text=$(basename "$f" | cut -f 1 -d '.'):fontcolor=white:fontsize=36:x=320:y=h-th-130:enable='between(t,0,13)" \
